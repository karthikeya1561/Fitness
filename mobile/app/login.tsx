        ...
        <SafeAreaView className="flex-1 bg-background-light dark:bg-background-dark">
            <ScrollView contentContainerClassName="flex-grow justify-center p-6">
                <View className="items-center mb-8">
                    <Text className="text-slate-900 dark:text-white text-3xl font-black mb-2">Welcome Back</Text>
                    <Text className="text-slate-500 dark:text-[#92c9a4] text-lg">Ready for your workout?</Text>
                </View>
                ...
                <View className="bg-white dark:bg-[#193322]/40 p-6 rounded-xl border border-slate-200 dark:border-[#23482f] shadow-sm">
                        ...
                        <View className="gap-4">
                            ...
                            <View className="flex-row justify-between items-center">
                                <View className="flex-row items-center gap-2">
                                    ...
                                    <View className="w-4 h-4 border border-slate-300 rounded" />
                                    <Text className="text-slate-600 dark:text-[#92c9a4] text-sm">Remember me</Text>
                                </View>
                                <TouchableOpacity>
                            ...
                            <TouchableOpacity
                                ...
                                disabled={isLoading}
                            >
                                <Text className="text-[#102216] text-lg font-bold">{isLoading ? 'Verifying...' : 'Log In'}</Text>
                            </TouchableOpacity>
                        </View>
                    ) : (
                        <View className="gap-4">
                            {!showOtpField ? (
                                <>
                                    ...
                                    <TouchableOpacity onPress={() => setAuthMethod('email')}>
                                        <Text className="text-primary text-center text-sm mt-2">Back to Email Login</Text>
                                    </TouchableOpacity>
                                </>
                            ) : (
                                <>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        disabled={isLoading}
                                    >
                                        <Text className="text-[#102216] text-lg font-bold">{isLoading ? 'Verifying...' : 'Verify & Log In'}</Text>
                                    </TouchableOpacity>
                    ...
                    <View className="flex-row items-center my-6">
                        ...
                        <Text className="mx-4 text-xs uppercase tracking-widest text-slate-400 dark:text-[#92c9a4]">Or continue with</Text>
                        <View className="flex-1 h-px bg-slate-200 dark:bg-[#326744]" />
                    </View>
                ...
                <View className="flex-row justify-center mt-8">
                    <Text className="text-slate-600 dark:text-[#92c9a4]">New to FitTrack? </Text>
